...
async function handleSubmit(event) {
  ...
  if (formType === 'visitor') {
    ...
    const botSettings = { ...currentBot, enabled: publicForm ? publicForm.querySelector('[name="botPlanningEnabled"]')?.checked !== false : currentBot.enabled !== false, youtubeUrl: publicValue('botYoutubeUrl', currentBot.youtubeUrl || ''), timezone: 'America/Sao_Paulo', provider: 'zapster', channel: 'WhatsApp', senderMode: 'platform_shared', senderLabelMode: 'church_only', visitorSequence: 'once_ever' };
