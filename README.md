...
- Service worker: `emaus-shell-v45`;
...
- `GET/POST/PATCH/DELETE /api/church/events` e `POST /api/church/events/bulk`; edição completa de nome, data, horário, local, categoria, público e situação (ativo, pausado ou bloqueado);
